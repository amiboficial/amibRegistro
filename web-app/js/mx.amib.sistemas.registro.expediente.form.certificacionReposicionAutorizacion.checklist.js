...
app.CheckSubmitView = Backbone.View.extend({
	...
	submitDatos: function(){
		...
		if(arr[app.CHK_CAMBFIGEX].model.get('idMetodoValidacion') == app.RCA_MV_EXAMEN){
		...
		else if(arr[app.CHK_CAMBFIGEX].model.get('idMetodoValidacion') == app.RCA_MV_PUNTOS){
			this.$("#spnHdnPostData").append('<input type="hidden" name="validacion.puntaje" value="' + arr[app.CHK_CAMBFIGEX].model.get('puntaje') + '" />');
		}
		...
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.id" value="' + arr[app.CHK_CAMBFIGEX].model.get('grailsId') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.idVarianteFigura" value="' + arr[app.CHK_CAMBFIGEX].model.get('idVarianteFigura') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.fechaObtencion_day" value="' + arr[app.CHK_CAMBFIGEX].model.get('fechaObtencion_day') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.fechaObtencion_month" value="' + arr[app.CHK_CAMBFIGEX].model.get('fechaObtencion_month') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.fechaObtencion_year" value="' + arr[app.CHK_CAMBFIGEX].model.get('fechaObtencion_year') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.fechaInicio_day" value="' + arr[app.CHK_CAMBFIGEX].model.get('fechaInicio_day') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.fechaInicio_month" value="' + arr[app.CHK_CAMBFIGEX].model.get('fechaInicio_month') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.fechaInicio_year" value="' + arr[app.CHK_CAMBFIGEX].model.get('fechaInicio_year') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.fechaFin_day" value="' + arr[app.CHK_CAMBFIGEX].model.get('fechaFin_day') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.fechaFin_month" value="' + arr[app.CHK_CAMBFIGEX].model.get('fechaFin_month') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.fechaFin_year" value="' + arr[app.CHK_CAMBFIGEX].model.get('fechaFin_year') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.statusEntHistorialInforme" value="' + arr[app.CHK_CAMBFIGEX].model.get('statusEntHistorialInforme') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.obsEntHistorialInforme" value="' + arr[app.CHK_CAMBFIGEX].model.get('obsEntHistorialInforme') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.statusEntCartaRec" value="' + arr[app.CHK_CAMBFIGEX].model.get('statusEntCartaRec') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.obsEntCartaRec" value="' + arr[app.CHK_CAMBFIGEX].model.get('obsEntCartaRec') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.statusConstBolVal" value="' + arr[app.CHK_CAMBFIGEX].model.get('statusConstBolVal') + '" />');
		this.$("#spnHdnPostData").append('<input type="hidden" name="certificacion.obsConstBolVal" value="' + arr[app.CHK_CAMBFIGEX].model.get('obsConstBolVal') + '" />');
		//datos de puestos
