<%@ page contentType="text/html;charset=UTF-8" %>
					...
					<a class="list-group-item">
					  	...
					  	<div class="motivoRow row">
					  		...
					  		<div class="col-sm-4">La persona se separó del cargo en muy malas condiciones.</div>
					  	</div>
					  	<div class="fechaBajaRow row">
					  		<label class="col-sm-3 control-label">Fecha de baja</label>
					  		<div class="col-sm-4">17 de junio de 2014</div>
					  	</div>
					...
					<a class="list-group-item">
						<div class="row">
					  	...
					  	<div class="row has-error">
					  		<label class="col-sm-3 control-label">Número de escritura a revocar</label>
					  		<div class="col-sm-4">
					  			<input class="form-control" type="text" value="99665874"/>
					  		</div>
					  		<div class="hidden-xs hidden-sm hidden-md col-lg-offset-2 col-lg-3">
					  			<div style="text-align:center; margin-top: -0.5em; margin-bottom: -0.5em">
					  	...
					  	<div class="row">
					  		<label class="col-sm-3 control-label">Motivo</label>
					  		<div class="col-sm-4">
					  			<textarea class="form-control" rows="3" style="resize:none">La persona se separó del cargo en muy malas condiciones.</textarea>
					  		</div>
					  	</div>
					  	<div class="row">
					  		<label class="col-sm-3 control-label">Fecha de baja</label>
					  		<div class="col-sm-4">
						  		<select class="form-control"><option value="null">-Seleccione-</option>
					...
					<a class="list-group-item">
						...
						<div id="msgErrorPeticion" class="alert alert-danger">
							<span class="glyphicon glyphicon-ban-circle"></span> Ha habído un error al procesar la petición.
						</div>
					
						<div class="row">
					  		<label class="col-sm-3 control-label">Número de Matrícula</label>
					  		<div class="col-sm-4"><input class="form-control" type="text" value="1256"/></div>
					  	</div>
					  	<div class="row">
					  		<label class="col-sm-3 control-label">Nombre completo</label>
					  		<div class="col-sm-4"><input class="form-control" type="text" value="Pedrito Fernández Junior de los Santos" disabled/></div>
					  	</div>
					  	<div class="row">
					  		<label class="col-sm-3 control-label">Número de escritura a revocar</label>
					  		<div class="col-sm-4">
					  		...
					  		<div class="hidden-xs hidden-sm hidden-md col-lg-offset-2 col-lg-3">
					  			<div style="text-align:center; margin-top: -0.5em; margin-bottom: -0.5em">
						  			<button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span> Agregar</button>
						  			<button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-remove"></span> Cancelar</button>
					  			</div>
					  		</div>
					  	</div>
