...
app.EXP_GRAL_ERRMSG_NOGEN = "EXP_GRAL_ERRMSG_NOGEN";//no se usa
...
app.EXP_GRAL_ERRMSG_NOEDOCIVIL = "Debe seleccionar un valor en el campo Estado Civil";
app.EXP_GRAL_ERRMSG_NONIVEST = "Debe seleccionar un valor en el campo nivel de estudios";
app.EXP_GRAL_ERRMSG_NONAL = "Debe seleccionar un valor en el campo nacionalidad";
