...
<body>
	...
	<form id="frmApp" class="form-horizontal" role="form" action="<g:createLink controller="expediente" action="consulta" />" method="get">
	...
	$(".revisar").click(function(e){ 
		...
		window.location.href = '<g:createLink controller="expediente" action="showless" id="' + folio + '"/>'
	});
