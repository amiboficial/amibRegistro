...
app.APODERADOS_ERRMSG_EPROC = "Error al procesar la petición"; //ERROR AL PROCESAR LA PETICION
app.APODERADOS_ERRMSG_ALREADY = "La mátricula ya se encuentra en la lista ";
