	...
	<fieldset>
		...
		<div class="form-group div-fechaObtencion">
			...
			<div class="col-md-5 col-sm-5">
				<select style="width: 28%;" class="form-control col-md-4 fechaObtencion_day">
				...
				<select style="width: 38%;" class="form-control col-md-4 fechaObtencion_month">
					<option value="-1">-Seleccione-</option>
				...
				<select style="width: 34%;" class="form-control col-md-4 fechaObtencion_year">
					<option value="-1">-Seleccione-</option>
		...
		<div class="form-group div-tipoAutorizacionFigura">
			<label class="col-md-2 col-sm-3 control-label">
